...
print("(DecisionTree) Train accuracy: {:.3f}".format(acc_train_tree))
print("(DecisionTree) Test accuracy: {:.3f}".format(acc_test_tree))
...
model = Sequential()
model.add(Dense(1024, activation=('relu'), input_shape=(15,)))
...
print("(RandomForest) Train accuracy: {:.3f}".format(accuracy_score(y_train, train_predictions)))
print("(RandomForest) Test accuracy: {:.3f}".format(accuracy_score(y_test, test_predictions)))
...
print("(SVM) Train accuracy: {:.3f}".format(accuracy_score(y_train, svm_train_predictions)))
print("(SVM) Test accuracy: {:.3f}".format(accuracy_score(y_test, svm_test_predictions)))
...
fig.savefig('accuracy-loss.png', dpi=400)